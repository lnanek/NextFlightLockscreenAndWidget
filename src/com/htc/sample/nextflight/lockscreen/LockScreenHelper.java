...
import com.htc.support.HtcBuild;
...
public class LockScreenHelper {
	...
	public static boolean openLockScreenChooser(final Context context) {
		...
		final Intent chooseLockScreen = new Intent("com.htc.intent.ACTION_PERSONALIZE_IDLESCREEN");
		context.startActivity(chooseLockScreen);
		return true;
	}
	
	private static boolean isLockScreenOfferedBySenseVersion() {
		final String senseVersion = HtcBuild.getSenseVersion();
		Log.d(LOG_TAG, "isLockScreenOfferedBySenseVersion senseVersion = " + senseVersion);
